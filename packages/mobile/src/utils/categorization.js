...
export const categorizeTransaction = (transaction) => {
    ...
    // NOTE: In the backend, this is Priority 1. We must match that behavior.
    if (transaction.category && transaction.category.length > 0 && transaction.category[0]) {
        ...
        // If it's a known Plaid category, return it
        // If it's just a generic string, we might want to check patterns too?
        // But backend logic returns here.
        return {
